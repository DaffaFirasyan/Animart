                    ...
                    <form action="{{ route('bahan-baku.store') }}" method="POST">
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <x-text-input id="nama_bahan" class="block mt-1 w-full" type="text" name="nama_bahan" :value="old('nama_bahan')" required autofocus />
                                <x-input-error :messages="$errors->get('nama_bahan')" class="mt-2" />
                            </div>

                            <div>
                                <x-input-label for="stok_saat_ini" :value="__('Stok Saat Ini')" />
                                <x-text-input id="stok_saat_ini" class="block mt-1 w-full" type="number" step="0.01" name="stok_saat_ini" :value="old('stok_saat_ini')" required />
                            ...
                            <div>
                                ...
                                <x-text-input id="stok_minimum" class="block mt-1 w-full" type="number" step="0.01" name="stok_minimum" :value="old('stok_minimum', 0)" required />
