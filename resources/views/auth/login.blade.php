...
<head>
    ...
    <style>
        /* Ricebowl Animart Theme (Diimpor dari register.blade.php) */
        :root {
            --ricebowl-red: #DC2626;
        ...
        <div class="relative z-10 w-full max-w-sm animate-fade-in-up">
            ...
            <div class="relative bg-white dark:bg-gray-800 shadow-2xl overflow-hidden rounded-2xl border-2 border-red-100 dark:border-red-900/30 card-ricebowl">
                ...
                <div class="px-5 py-4">
                    ...
                    @if (session('status'))
                        <div class="mb-4 relative overflow-hidden bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 border border-green-500 dark:border-green-600 p-3 rounded-xl shadow-md animate-fade-in-up">
                            <div class="flex items-center space-x-2">
                                <div class="flex-shrink-0">
                                    <div class="w-6 h-6 bg-gradient-to-br from-green-500 to-emerald-500 rounded-full flex items-center justify-center shadow-md">
                                        <svg class="w-3.5 h-3.5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M5 13l4 4L19 7" />
                                        </svg>
                                    </div>
                                </div>
                                <p class="text-green-800 dark:text-green-200 font-semibold text-xs">{{ session('status') }}</p>
                            </div>
                        </div>
                    @endif
                        ...
                        <div class="flex items-center justify-between text-xs pt-1">
                            <label for="remember_me" class="inline-flex items-center cursor-pointer group">
                                <input id="remember_me" 
                                       type="checkbox" 
                                       name="remember"
                                       class="w-3.5 h-3.5 rounded border-2 border-gray-300 dark:border-gray-600 text-orange-600 shadow-sm focus:ring-2 focus:ring-orange-500/20 dark:bg-gray-700 transition-all duration-300 cursor-pointer">
                                <span class="ml-1.5 font-semibold text-gray-700 dark:text-gray-300 group-hover:text-orange-600 dark:group-hover:text-orange-400 transition-colors duration-300">
                                    Remember me
                                </span>
                            </label>
                            ...
                            @if (Route::has('password.request'))
                                <a href="{{ route('password.request') }}" 
                                   class="font-bold text-red-600 hover:text-orange-600 dark:text-red-400 dark:hover:text-orange-400 transition-colors duration-300 flex items-center space-x-0.5 group">
                                    <svg class="w-3 h-3 group-hover:rotate-12 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2.5">
                ...
                <div class="px-5 py-2.5 bg-gradient-to-r from-orange-50 to-yellow-50 dark:from-gray-700 dark:to-gray-700/50 border-t-2 border-orange-100 dark:border-gray-600">
                    <div class="flex items-center justify-center space-x-1.5 text-xs text-gray-600 dark:text-gray-400">
                        ...
                        <span class="font-semibold">Sistem login aman & terenkripsi</span>
                    </div>
                </div>
            </div>
